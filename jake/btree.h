...
namespace badgerdb
{
  ...
  class BTreeIndex {
    ...
    private:
      ...
      // Swap x PageKeyPair with y PageKeyPair if x < y
      void swapDoublePageKeyPair(PageKeyPair<double>* x, PageKeyPair<double>* y);

      // Swap x RIDKeyPair with y RIDKeyPair if x < y
      void swapDoubleRIDKeyPair(RIDKeyPair<double>* x, RIDKeyPair<double>* y);

      // Sort the key array and pageNo array
      void insertDoubleNonLeafArray(void* array, void* pageArray, int& numItems, PageKeyPair<double>* x);

      // Sort the key array and Rid array
      void insertDoubleLeafArray(void* array, void* ridArray, int& numItems, RIDKeyPair<double>* x);
