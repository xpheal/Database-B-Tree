...
class BTreeIndex {
 ...
 private:
  ...
  PageId insertIntegerRecord(const void *key, const RecordId rid, PageId currPage);
  //const void sort(const void *key, const rid, *page, bool isLeaf);
  const void sort(void *page, const void *key, void *rid, bool isLeaf);
